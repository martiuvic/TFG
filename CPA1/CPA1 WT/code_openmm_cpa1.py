...
prmtop = app.AmberPrmtopFile("5om9_ph7_protonated_changedholoactive_wat.prmtop")
inpcrd = app.AmberInpcrdFile("5om9_ph7_protonated_changedholoactive_wat_init0.rst")
...
sim.reporters.append(StateDataReporter("/home/marti/results/CPA1_output.log",
...
sim.reporters.append(CheckpointReporter('/home/marti/results/CPA1_chk_out.rst',20000))
...
sim.reporters.append(DCDReporter("/home/marti/results/CPA1.dcd",20000))
