...
prmtop = app.AmberPrmtopFile("G278S_wat.prmtop")
inpcrd = app.AmberInpcrdFile("G278S_wat_init0.rst")
...
sim.reporters.append(StateDataReporter("G278S_output.log",
...
sim.reporters.append(CheckpointReporter('G278S_chk_out.rst',20000))
...
sim.reporters.append(DCDReporter("G278S.dcd",20000))
