...
prmtop = app.AmberPrmtopFile("G167D_wat.prmtop")
inpcrd = app.AmberInpcrdFile("G167D_wat_init0.rst")
...
with open("/home/marti/results/G167D_chk_out.rst",'rb') as f:
...
datafile=open("/home/marti/results/G167D_output.log","a")
...
sim.reporters.append(DCDReporter("/home/marti/results/G167D.dcd",
    20000,
    append=True))
